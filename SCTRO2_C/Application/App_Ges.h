...
#define DELTA_TEMP_TERGET_FOR_STABILITY_PRIMING		12//5 //5 //4	//range per identificare il raggungimento della tmeperatura target esperro in decimi di grado (es 4 = 0.4°C)
