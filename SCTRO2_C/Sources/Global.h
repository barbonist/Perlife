...
/*----------++++++++++ FW REVISION ++++++++++----------*/
	 ...
	 * pari a 31.31.63  es la 1.1.0 sarà 0x0840*/
	 ...
	 * 0x0815 --> 1.0.21 *0x0816 --> 1.0.22 *0x0817 --> 1.0.23 *0x0818 --> 1.0.24 ... 0x0840 --> 1.1.0 ... 0x0841 --> 1.1.1*/

#ifndef VALIDAZIONE_PROTECTIVE
#define REVISION_FW_CONTROL 0x0841
#else
...
enum CommandId {
	...
	COMMAND_ID_SERVICE  = 0xCC
};

enum SubCommandId {
	SUB_COMMAND_ID_NULL 				= 0X00,
	SERVICE_MODBUS_WRITE_REG			= 0x15,
	SERVICE_MODBUS_READ_REG				= 0X16,
	SERVICE_MODBUS_READ_STATUS			= 0X17,
	SERVICE_PRESS_SENS_READ_VALUE		= 0X31,
	SERVICE_PRESS_SENS_READ_PARAM		= 0X32,
	SERVICE_PRESS_SENS_CAL_P0			= 0X33,
	SERVICE_PRESS_SENS_CAL_P1			= 0X34,
	SERVICE_TEMP_SENS_READ_VALUE		= 0X40,
	SERVICE_TEMP_SENS_READ_REG			= 0X41,
	SERVICE_TEMP_SENS_WRITE_REG			= 0X42,
	SERVICE_FLOW_SENS_READ				= 0X50,
	SERVICE_FLOW_SENS_RESET				= 0X51,
	SERVICE_PELTIER_READ_FLOAT			= 0X26,
	SERVICE_PELTIER_READ_INT			= 0X28,
	SERVICE_PELTIER_WRITE_FLOAT			= 0X27,
	SERVICE_PELTIER_WRITE_INT			= 0X29,
	SERVICE_PELTIER_START				= 0X20,
	SERVICE_PELTIER_STOP				= 0X21,
	SERVICE_PELTIER_WRITE_EE			= 0X22
};
...
#define OXYG_FLOW_TO_RPM_CONV 28.0
...
/*flag che dentifica l'avevnuta comunicazione con l' SBC
 * farò injiziare il T1_TEST solo dopo che è stata messa a TRUE*/
bool SBC_Control_communication_OK;
...
#define TEMP_RESTORE_SPEED 5500
...
/*gradi centigradi da sottrarre alla soglia di allarme T out of range
 * es: se va ho target a 4 °C, vado e 'CurrMaxDeltaT' a 2 °C vado in
 * allarme se temp >= 6 gradi per MAX_TEMP_ALM_TIME_DET_IN_TREAT msec (2 min)
 * rientrerò dalòl'allarme solo se la temperatura sarà <= 5 °C per
 * tenermi lontano dalla soglia di allarme)
 * */
#define HYSTERESIS 1
